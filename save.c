...
monstre* GetMonstres(char* name, int *nbMonstres) {
    ...
    while (fgets(ligne, sizeof(ligne), file) != NULL) {
        ...
        } else if (strstr(ligne, "pMax:") != NULL) {
            sscanf(ligne, "pMax:%d", &tableauMonstres[indexMonstre].pMax);
        } else if (strstr(ligne, "pMin:") != NULL) {
            sscanf(ligne, "pMin:%d", &tableauMonstres[indexMonstre].pMin);
        } else if (strstr(ligne, "def:") != NULL) {
            sscanf(ligne, "def:%d", &tableauMonstres[indexMonstre].def);
